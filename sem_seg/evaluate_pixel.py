...
execution example:
 - python3 evaluate_pixel.py --path_runs "/home/miguel/Desktop/pipes/dgcnn/sem_seg/RUNS/valve_test/" --path_cls "/home/miguel/Desktop/pipes/data/valve_test/classes.txt"
'''
...
def main():
    ...
    for run in run_folders:
        ...
        f = open(path_run + '/evaluation_pixel_' + test_name + '_.txt', 'w')
        f.write('\n')
        ...
        filepath = path_run + '/evaluation_pixel_' + test_name + '_.xlsx'
